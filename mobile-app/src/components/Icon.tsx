// Feather icon subset (MIT path data) + the design's custom glyphs
// (book / sparkle / users), rendered as stroke-currentColor SVGs.
const PATHS: Record<string, string> = {
  book: '<path d="M2 3h6a4 4 0 0 1 4 4v14a3 3 0 0 0-3-3H2z"/><path d="M22 3h-6a4 4 0 0 0-4 4v14a3 3 0 0 1 3-3h7z"/>',
  sparkle: '<path d="M12 3l2.2 6.3L20.5 12l-6.3 2.7L12 21l-2.2-6.3L3.5 12l6.3-2.7z"/><path d="M19 2v4"/><path d="M17 4h4"/>',
  ...
  play: '<path stroke="none" d="M7.35 4.05 17.9 10.72c.95.6.95 1.96 0 2.56L7.35 19.95c-1 .63-2.3-.08-2.3-1.27V5.32c0-1.19 1.3-1.9 2.3-1.27Z"/>',
  ...
  copy: '<rect x="8" y="8" width="13" height="13" rx="1.5"/><path d="M16 8V4.5A1.5 1.5 0 0 0 14.5 3h-11A1.5 1.5 0 0 0 2 4.5v11A1.5 1.5 0 0 0 3.5 17H8"/>',
